                ...
                .forEach(function (form) {
                    form.addEventListener('submit', function (event) {
                        ...
                        function error() {
                            ...
                            status.innerHTML = 'Oops, sorry! There was a problem with the form submission. Ensure to check "I\'m not a robot" and try again or use an alternative method to contact me.';
                        };
