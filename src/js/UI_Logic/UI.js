...
const UI = {
    /*** GENERAL ***/
    body: document.body,
    google_preview_modal_btn: document.querySelector(
    ...
    header_divider: document.querySelector(
        '.custom-shape-divider-bottom-1612032701',
    ),

    /*** ABOUT SECTION ***/
    about_summary_wrapper: document.querySelector(
    ...
    /*** SERVICES SECTION ***/
    my_carousel_prev_btn: document.querySelector(
        '.services-section .my-carousel-btn-prev',
    ),
    my_carousel_next_btn: document.querySelector(
    ...
    skill_ratings_intermediate: document.querySelectorAll(
    ...
    return_to_dev_gallery_btns: document.querySelectorAll(
    ...
    dev_project_gallery_btns: document.querySelectorAll(
        'button[data-dev-project]',
    ),
    dev_project_carousel: document.getElementById('dev-project-carousel'),
    dev_project_carousel_indicator_section: document.getElementById(
        'dev-project-carousel-indicators',
    ),
    dev_project_carousel_inner_section: document.getElementById(
        'dev-project-carousel-inner',
    ),
    dev_project_carousel_note_section: document.getElementById(
        'dev-project-carousel-notes',
    ),
    dev_project_carousel_icon_section: document.getElementById(
        'dev-project-carousel-icon-section',
    ),
    dev_project_carousel_next: document.querySelectorAll(
        '#dev-project-overview .carousel-control-next',
    ),
    dev_project_carousel_prev: document.querySelectorAll(
    ...
    client_project_gallery_btns: document.querySelectorAll(
        'button[data-client-project]',
    ),
    client_project_carousel: document.getElementById('client-project-carousel'),
    client_project_carousel_indicator_section: document.getElementById(
        'client-project-carousel-indicators',
    ),
    client_project_carousel_inner_section: document.getElementById(
        'client-project-carousel-inner',
    ),
    client_project_carousel_note_section: document.getElementById(
        'client-project-carousel-notes',
    ),
    client_project_carousel_icon_section: document.getElementById(
        'client-project-carousel-icon-section',
    ),
    client_project_carousel_next: document.querySelectorAll(
        '#client-project-overview .carousel-control-next',
    ),
    client_project_carousel_prev: document.querySelectorAll(
    ...
    /* Formspree */
    valid_feedback_fname: document.querySelector(
        '.valid-feedback.valid-feedback-fname',
    ),
    valid_feedback_lname: document.querySelector(
        '.valid-feedback.valid-feedback-lname',
    ),
    valid_feedback_email: document.querySelector(
        '.valid-feedback.valid-feedback-email',
    ),
    valid_feedback_country: document.querySelector(
        '.valid-feedback.valid-feedback-country',
    ),
    valid_feedback_message: document.querySelector(
        '.valid-feedback.valid-feedback-message',
    ),
    invalid_feedback_fname: document.querySelector(
        '.invalid-feedback.invalid-feedback-fname',
    ),
    invalid_feedback_lname: document.querySelector(
        '.invalid-feedback.invalid-feedback-lname',
    ),
    invalid_feedback_email: document.querySelector(
        '.invalid-feedback.invalid-feedback-email',
    ),
    invalid_feedback_country: document.querySelector(
        '.invalid-feedback.invalid-feedback-country',
    ),
    invalid_feedback_message: document.querySelector(
    ...
    toggler_menu_icon_switch() {
        setInterval(() => {
            if (
                this.toggler_btn_word.classList.contains('d-none') &&
                this.toggler_btn_word
            ) {
                this.toggler_btn_icon.classList.add('d-none');
                this.toggler_btn_word.classList.remove('d-none');
            } else if (
                this.toggler_btn_icon.classList.contains('d-none') &&
                this.toggler_btn_word
            ) {
    ...
    expand_placeholder_div() {
        ...
        this.body_placeholder.classList.replace(
    ...
    animate_letters() {
        ...
        this.text_wrapper_ml13.innerHTML =
            this.text_wrapper_ml13.textContent.replace(
                /\S/g,
    ...
    change_about_info() {
        if (this.summary_containers[1].classList.contains('d-none')) {
            ...
            setTimeout(() => {
                ...
                this.summary_containers[1].classList.remove(
                    'd-none',
                    'opacity-0',
                );
            ...
            setTimeout(() => {
                ...
                this.summary_containers[0].classList.remove(
                    'd-none',
                    'opacity-0',
                );
                this.summary_btn.innerHTML = `
    ...
    display_form_validation_msg() {
        ...
        if (
            ...
            window.getComputedStyle(this.invalid_feedback_fname).display !=
                'none'
        ) {
            this.valid_feedback_fname.innerHTML =
                'Nice! You remembered your first name!';
        }
        if (
            this.invalid_feedback_lname &&
            window.getComputedStyle(this.invalid_feedback_lname).display !=
                'none'
        ) {
            this.valid_feedback_lname.innerHTML =
                'So you do have a last name...';
        }
        if (
            this.invalid_feedback_email &&
            window.getComputedStyle(this.invalid_feedback_email).display !=
                'none'
        ) {
            this.valid_feedback_email.innerHTML =
                'Much better...please ensure that the spelling of your email is correct';
        }
        if (
            this.invalid_feedback_country &&
            window.getComputedStyle(this.invalid_feedback_country).display !=
                'none'
        ) {
            this.valid_feedback_country.innerHTML = 'Welcome to Earth ' + `👽`;
        }
        if (
            this.invalid_feedback_message &&
            window.getComputedStyle(this.invalid_feedback_message).display !=
                'none'
        ) {
            this.valid_feedback_message.innerHTML = 'Thank you, much better...';
        }
        return;
    },
};
