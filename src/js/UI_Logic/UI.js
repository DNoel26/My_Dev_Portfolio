...
const UI = {
    ...
    animate_letters() {
        ...
        this.text_wrapper_ml13.innerHTML = this.text_wrapper_ml13.textContent.replace(
            /\S/g,
    ...
    display_form_validation_msg() {
        ...
        if (
            ...
            window.getComputedStyle(this.invalid_feedback_fname).display != 'none'
        ) {
            this.valid_feedback_fname.innerHTML = 'Nice! You remembered your first name!';
        }
        if (
            this.invalid_feedback_lname &&
            window.getComputedStyle(this.invalid_feedback_lname).display != 'none'
        ) {
            this.valid_feedback_lname.innerHTML = 'So you do have a last name...';
        }
        if (
            this.invalid_feedback_email &&
            window.getComputedStyle(this.invalid_feedback_email).display != 'none'
        ) {
        ...
        if (
            ...
            window.getComputedStyle(this.invalid_feedback_country).display != 'none'
        ) {
